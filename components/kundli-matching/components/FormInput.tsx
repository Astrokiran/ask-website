...
export const FormInput: React.FC<FormInputProps> = ({ label, error, ...props }) => (
    <div>
        ...
        <input
            {...props}
            className={`w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-gray-50 dark:bg-gray-700 border rounded-lg focus:outline-none focus:ring-2 hover:border-orange-300 transition-colors duration-200 text-sm sm:text-base text-gray-900 dark:text-white ${
                error
