        ...
        <Card className="max-w-4xl mx-auto p-6 shadow-lg">
          <CardContent className="space-y-8">
            ...
            <div>
              ...
              <div>
                <ol className="p-2 pl-8 space-y-1 list-decimal">
                  <li>Information you provide: When you register on the Platform, you will be required to provide us with your name, location, email address, mobile number, display picture, date of birth, place of birth, time of birth, hand images or palm photographs (for palmistry consultation), and other relevant profile information you may choose to provide.</li>
                  ...
                  <li>Messages. When you use our Platform to communicate, we receive and store the messages you may send or receive on the Platform, and any other content you may upload or share on the Platform, including reviews and ratings about astrologers.</li>
            ...
            <div>
              ...
              <p>We store your information on secure servers in a controlled environment. Sensitive information such as date of birth, time of birth, place of birth, and palm images are stored in encrypted form. We take reasonable measures to protect your information from unauthorized access, use, or disclosure.</p>
            </div>
            ...
            <div>
              ...
              <div>
                <ul className="list-disc pl-5 p-2">
                  ...
                  <li>We may share your information with other users of the platform if you consent to such sharing (for example, reviews you write about astrologers will be visible to other users).</li>
                </ul>
              </div>
            </div>
            ...
            <div>
              ...
              <p>We will retain your information for as long as is necessary to provide you with our services. Birth details, palm images, and consultation content will be retained only for as long as required to provide the relevant service or maintain your consultation history. We may also retain your information for a longer period if we are required to do so by law or if we believe that it is necessary to protect our interests.</p>
            ...
            <div>
              ...
              <p>You have the right to access, correct, and delete your personal information. You can also object to the processing of your personal information or withdraw your consent at any time. You may also report or request removal of reviews and astrologer profiles that you believe are inappropriate.</p>
            ...
            <div>
              ...
              <p>We take reasonable measures to protect your personal information from unauthorized access, use, or disclosure. Sensitive information (such as palm images and birth details) is encrypted at rest and in transit. However, no system is completely secure. We cannot guarantee the security of your personal information.</p>
            </div>
