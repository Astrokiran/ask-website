          ...
          <div className="max-w-4xl mx-auto mb-12">
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Why Read Daily Horoscopes?</h2>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">What Makes Our Predictions Special?</h2>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl border border-gray-200 dark:border-gray-700">
              <h2 className="text-2xl font-semibold mb-4 text-center text-gray-900 dark:text-white">Understanding Your Zodiac Sign</h2>
